  ...
  return (
    <section className="bg-[#f7f7f7] px-5 py-14 md:py-16">
      ...
      <div className="text-center mb-10">
        <h2 className="text-5xl md:text-3xl font-bold text-[#222] tracking-widest uppercase mb-2">
          Explore Jobs
        </h2>
            ...
            <ul className="space-y-2.5">
              {col.items.map((item) => (
                <li key={item.label}>
                  <Link
                    href={item.href}
                    className="flex items-center gap-2 text-sm text-gray-500 hover:text-[#e74c3c] transition-colors duration-200 group"
                  >
                    <span className="w-1.5 h-1.5 rounded-full bg-[#e74c3c] shrink-0 group-hover:bg-[#c0392b] transition-colors duration-200" />
                    {item.label}
                  </Link>
                </li>
              ))}
              ...
              {col.moreLink && (
                <li>
                  <Link
                    href={col.moreLink}
                    className="text-xs font-semibold text-[#e74c3c] hover:text-[#c0392b] transition-colors duration-200 mt-1 inline-block"
                  >
                    + More Jobs
                  </Link>
                </li>
